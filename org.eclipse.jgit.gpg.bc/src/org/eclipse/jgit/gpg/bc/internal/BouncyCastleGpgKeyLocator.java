...
public class BouncyCastleGpgKeyLocator {
	...
	private static void hash_q25519(SHA1 grip, BigInteger q)
			throws PGPException {
	...
	static byte[] hash_ed25519(SHA1 grip, BigInteger q) throws PGPException {
	 ...
	 */
	@SuppressWarnings("nls")
	static byte[] hash_curve25519(SHA1 grip, BigInteger q) throws PGPException {
		hash(grip, Hex.decode(
				"7FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFED"),
				'p', false);
