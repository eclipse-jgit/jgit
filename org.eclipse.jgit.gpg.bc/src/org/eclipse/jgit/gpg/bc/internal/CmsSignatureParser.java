...
class CmsSignatureParser implements SignatureParser {
	...
	private static final String SIGNATURE_PREFIX = "-----BEGIN SIGNED MESSAGE-----\n"; //$NON-NLS-1$
	private static final String SIGNATURE_SUFFIX = "\n-----END SIGNED MESSAGE-----"; //$NON-NLS-1$
	private static final int BEGIN_DELIMITER_LEN = SIGNATURE_PREFIX.length();
	private static final int END_DELIMITER_LEN = SIGNATURE_SUFFIX.length();
