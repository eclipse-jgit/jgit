...
import static org.eclipse.jgit.lfs.internal.LfsConnectionFactory.CONFIG_KEY_LFSDEFAULT;
import static org.eclipse.jgit.lfs.internal.LfsConnectionFactory.CONFIG_KEY_LFSPUSHDEFAULT;
import static org.eclipse.jgit.lfs.internal.LfsConnectionFactory.CONFIG_KEY_LFSPUSHURL;
import static org.eclipse.jgit.lfs.internal.LfsConnectionFactory.CONFIG_KEY_LFSURL;
import static org.eclipse.jgit.lfs.internal.LfsConnectionFactory.CONFIG_KEY_PUSHURL;
...
public class LfsConnectionFactoryTest extends RepositoryTestCase {
	...
	public void lfsUrlFromLocalConfig() throws Exception {
		...
		// set remote explicitly -> specified remote should be picked
		...
		setConfig(ConfigConstants.CONFIG_SECTION_LFS,
				null,
		...
		setConfig(ConfigConstants.CONFIG_SECTION_LFS, null,
				LfsConnectionFactory.CONFIG_KEY_PUSHURL,
