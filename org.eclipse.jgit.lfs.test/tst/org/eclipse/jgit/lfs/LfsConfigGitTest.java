...
public class LfsConfigGitTest extends RepositoryTestCase {
	...
	private void createLfsFiles(String lfsPointer) throws Exception {
		 ...
		 * the desired checkout order before and after ".lfsconfig", at least in
		 * a number of manual tries. Since the files to checkout are contained
		 * in a set (see DirCacheCheckout::doCheckout) the order cannot be
		 * guaranteed.
		 */
