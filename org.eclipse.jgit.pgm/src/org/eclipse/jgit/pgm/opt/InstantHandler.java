...
public class InstantHandler extends OptionHandler<Instant> {
	 ...
	 */
	public InstantHandler(final CmdLineParser parser, final OptionDef option,
			final Setter<? super Instant> setter) {
	...
	public int parseArguments(Parameters params) throws CmdLineException {
		final Instant instant = Instant.parse(params.getParameter(0));
