...
maven_jar(
    ...
    sha1 = "a0532912e6af8f8e328bfb480226a17b3a662496",
)

maven_jar(
    name = "jetty-security",
    artifact = "org.eclipse.jetty:jetty-security:" + JETTY_VER,
    sha1 = "5eb766e070cf926588ec67d12f33d0da42f57237",
)

maven_jar(
    name = "jetty-server",
    artifact = "org.eclipse.jetty:jetty-server:" + JETTY_VER,
    sha1 = "03871dbb3c7f4b4e6c6ecfd2e5f91fd1d33442e6",
)
...
maven_jar(
    ...
    sha1 = "dc59a0f4156c94b6a7949c0a775ce51642db0395",
)

maven_jar(
    name = "jetty-io",
    artifact = "org.eclipse.jetty:jetty-io:" + JETTY_VER,
    sha1 = "6a1f61ddde45854b34e046ed5070b24029b99f84",
)

maven_jar(
    name = "jetty-util",
    artifact = "org.eclipse.jetty:jetty-util:" + JETTY_VER,
    sha1 = "a57e10e3c01996fd376de4a42f1e06b4676a1bae",
)

maven_jar(
    name = "jetty-util-ajax",
    artifact = "org.eclipse.jetty:jetty-util-ajax:" + JETTY_VER,
    sha1 = "4b08a89818c1d5bd97e1bed0d40f1e80a4fd73e8",
)

maven_jar(
    name = "jetty-ee8-nested",
    artifact = "org.eclipse.jetty.ee8:jetty-ee8-nested:" + JETTY_VER,
    sha1 = "6ba23f77835f4e65b570fb23fcebb2721c82256c",
)

maven_jar(
    name = "jetty-ee8-security",
    artifact = "org.eclipse.jetty.ee8:jetty-ee8-security:" + JETTY_VER,
    sha1 = "64b2962a54beda7ff8439631f458ef7e309b2b50",
)
