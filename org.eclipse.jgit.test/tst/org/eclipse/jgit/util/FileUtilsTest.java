...
public class FileUtilsTest {
	...
	public void testDeleteFile() throws IOException {
		...
		try {
			...
			throw new AssertionError("deletion of non-existing file must not fail with option SKIP_MISSING", e);
		}
	}
	...
	public void testDeleteRecursive() throws IOException {
		...
		try {
			...
			throw new AssertionError("recursive deletion of non-existing directory must not fail with option SKIP_MISSING", e);
		}
	}
