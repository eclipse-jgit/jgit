...
public class InterruptTimerTest {
	...
	@Test
	public void testNotInterruptedAfterEnd() throws IOException {
		int interrupted = 0;;
		try {
			timer.begin(TIMEOUT_LONG_ENOUGH);
			Thread.sleep(SHORT_ENOUGH);
	...
	@Test
	public void testRestartBeforeTimeout() throws IOException {
		int interrupted = 0;;
		try {
	...
	@Test
	public void testSecondExpiresBeforeFirst() throws IOException {
		int interrupted = 0;;
		try {
