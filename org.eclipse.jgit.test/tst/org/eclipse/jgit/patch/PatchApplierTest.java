...
public class PatchApplierTest {
	...
	public abstract static class Base extends RepositoryTestCase {
		...
		void verifyChange(Result result, String aName, boolean exists, int numConflicts)
				throws Exception {
		...
		public void testConflictMarkers() throws Exception {
			...
			assertEquals(result.getErrors(), List.of(new PatchApplier.Result.Error("cannot apply hunk","allowconflict", null)));
		...
		public void testConflictMarkersOutOfBounds() throws Exception {
			...
			assertEquals(result.getErrors(), List.of(new PatchApplier.Result.Error("cannot apply hunk","ConflictOutOfBounds", null)));
