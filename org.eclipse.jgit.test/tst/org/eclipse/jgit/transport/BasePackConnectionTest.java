...
public class BasePackConnectionTest {
	...
	public void testReadAdvertisedShouldThrowExceptionWithOriginalCause() throws URISyntaxException {
		...
		FailingBasePackConnection basePackConnection = new FailingBasePackConnection(uri, originalException,
	...
	private static class FailingBasePackConnection extends BasePackConnection {
		...
		FailingBasePackConnection(URIish uri, Throwable noRepositoryCauseException, IOException readStringException,
