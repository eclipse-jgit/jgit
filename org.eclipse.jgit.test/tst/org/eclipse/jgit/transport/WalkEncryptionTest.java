...
// TODO: uncomment before completion of junit 5 migration, confuses openrewrite
...
//		}
//
//		static List<Arguments[]> product(List<String> one, List<String> two) {
//			List<Arguments[]> result = new ArrayList<>();
//			for (String s1 : one) {
//				for (String s2 : two) {
//					result.add(new Arguments[] { Arguments.of(s1),
//							Arguments.of(s2) });
//				}
//			}
//			return result;
...
//
//		public static Collection<Arguments[]> argsList() {
...
//
//		@ParameterizedTest(name = "Profile: {0}   Version: {1}")
//		@MethodSource("argsList")
//		public void testCrypto(String profile, String version)
//				throws Exception {
