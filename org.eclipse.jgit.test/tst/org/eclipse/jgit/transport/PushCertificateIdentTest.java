...
public class PushCertificateIdentTest {
	...
	public void timezoneRange_hours() {
		...
		// java.time.ZoneId: only valid timezones between [-18, 18]
	...
	public void timezoneRange_minutes() {
		PushCertificateIdent minutesLimit = PushCertificateIdent
				.parse("A U. Thor <a_u_thor@example.com> 1218123387 +0059");
		assertEquals(59, minutesLimit.getTimeZoneOffset());
		assertEquals(59 * 60 * 1000,
				minutesLimit.getTimeZone().getOffset(1218123387));
