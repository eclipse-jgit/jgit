...
public class TestProtocolTest {
  ...
  @Before
	...
	public void fetchReportsLockFailureWhenAutoFollowTagIsCreated()
		...
		URIish uri = registerTestProtocolUpdatingRef((repo) -> repo.lightweightTag(TAG_NAME, localCommit));
	...
	public void fetchReportsLockFailureWhenDestinationRefChanges()
		...
		URIish uri = registerTestProtocolUpdatingRef((repo) -> repo.update(LOCAL_BRANCH_NAME, newLocalCommit));
