...
public class RefDirectoryTest extends LocalDiskRepositoryTestCase {
	...
	@Test
	public void doNotAddPeeledTraitIfContainsAnyUnpeeledTags() throws Exception {
		...
		String content = read(packedRefsFile);
		String firstLine = content.split("\n")[0];
		assertFalse("packed-refs should NOT have peeled trait", firstLine.contains(" peeled"));

		assertFalse(refdir.getPackedRefs().traits().contains(PackedRefsTrait.PEELED));
