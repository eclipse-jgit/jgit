...
public class BasePackBitmapIndexTest {
	...
	private static final StoredBitmap newBaseStoredBitmap(
			ObjectId oid, EWAHCompressedBitmap base) {
		return new StoredBitmap(oid, base, null, 0);
	}

	private static StoredBitmap newXorStoredBitmap(
			ObjectId oid, EWAHCompressedBitmap xorMask,
			StoredBitmap base) {
