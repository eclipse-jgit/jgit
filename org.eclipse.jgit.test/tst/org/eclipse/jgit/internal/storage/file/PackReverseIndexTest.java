...
public class PackReverseIndexTest {
	...
	public void open_fallbackToComputed() throws IOException {
		...
		PackReverseIndex computed = PackReverseIndex.openOrCompute(
	...
	public void open_readCorruptFile() {
		...
		assertThrows(IOException.class, () -> PackReverseIndex.openOrCompute(
				getResourceFileFor(hasRevFilePrefix + "corrupt.", PackExt.REVERSE_INDEX), 6,
				() -> PackIndex.open(getResourceFileFor(hasRevFilePrefix, PackExt.INDEX))));
	}
	...
	public void read_badMagic() {
		byte[] badMagic = new byte[] { 'R', 'B', 'A', 'D', // magic
				...
				// pack checksum
				'P', 'A', 'C', 'K', 'C', 'H', 'E', 'C', 'K', 'S', 'U', 'M', '3', '4', '5', '6', '7', '8', '9', '0',
				// checksum
				0x66, 0x01, (byte) 0xbc, (byte) 0xe8, 0x51, 0x4b, 0x2f, (byte) 0xa1, (byte) 0xa9, (byte) 0xcd,
				(byte) 0xbe, (byte) 0xd6, 0x4f, (byte) 0xa8, 0x7d, (byte) 0xab, 0x50, (byte) 0xa3, (byte) 0xf7,
				(byte) 0xcc,
		};
	...
	public void read_unsupportedVersion2() {
		byte[] version2 = new byte[] { 'R', 'I', 'D', 'X', // magic
				...
				'P', 'A', 'C', 'K', 'C', 'H', 'E', 'C', 'K', 'S', 'U', 'M', '3', '4', '5', '6', '7', '8', '9', '0',
				// checksum
				0x70, 0x17, 0x10, 0x51, (byte) 0xfe, (byte) 0xab, (byte) 0x9b, 0x68, (byte) 0xed, 0x3a, 0x3f, 0x27,
				0x1d, (byte) 0xce, (byte) 0xff, 0x38, 0x09, (byte) 0x9b, 0x29, 0x58,
		};
	...
	private File getResourceFileFor(String packFilePrefix, PackExt ext) {
		return JGitTestUtil.getTestResourceFile(packFilePrefix + ext.getExtension());
	}
}
