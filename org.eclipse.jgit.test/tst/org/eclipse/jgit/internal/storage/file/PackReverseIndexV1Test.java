...
public class PackReverseIndexV1Test {
	private static final byte[] FAKE_PACK_CHECKSUM =
			new byte[] { 'P', 'A', 'C', 'K', 'C', 'H', 'E', 'C', 'K', 'S', 'U',
					'M', '3', '4', '5', '6', '7', '8', '9', '0',
			};
	private static final byte[] NO_OBJECTS =
			new byte[] { 'R', 'I', 'D', 'X', // magic
					...
					(byte) 0x8f, 0x45, 0x7e, 0x06, (byte) 0x91, (byte) 0xf2,
					0x7e, 0x20, 0x35, 0x2c, (byte) 0xdc, 0x4c, 0x46,
					(byte) 0xe4,
			};
	private static final byte[] SMALL_PACK_CHECKSUM =
			new byte[] { (byte) 0xbb, 0x1d, 0x25, 0x3d, (byte) 0xd3,
					(byte) 0xf0, 0x08, 0x75, (byte) 0xc8, 0x04, (byte) 0xd0,
					0x6f, 0x73, (byte) 0xe9, 0x00, (byte) 0x82, (byte) 0xdb,
					0x09, (byte) 0xc8, 0x13,
			};
	private static final byte[] SMALL_CONTENTS =
			new byte[] { 'R', 'I', 'D', 'X', // magic
					0x00, 0x00, 0x00, 0x01, // file version
					0x00, 0x00, 0x00, 0x01, // oid version
					...
					(byte) 0xc1, 0x36, 0x26, (byte) 0xbc, (byte) 0xcb, 0x75,
					0x36, (byte) 0xa1, 0x26, 0x6a, 0x2b, (byte) 0x84, 0x16,
					(byte) 0x83,
			};
	...
	private final PackedObjectInfo object614 =
			objectInfo("2d04ee74dba30078c2dcdb713ddb8be4bc084d76", OBJ_BLOB,
					614);
	private final PackedObjectInfo object450 =
			objectInfo("58728c938a9a8b9970cc09236caf94ada4689923", OBJ_BLOB,
					450);
	private final PackedObjectInfo object165 =
			objectInfo("5ce00008cf3fb8f194f52742020bd40d78f3f1b3", OBJ_COMMIT,
					165);
	private final PackedObjectInfo object257 =
			objectInfo("62299a7ae290d685196e948a2fcb7d8c07f95c7d", OBJ_TREE,
					257);
	private final PackedObjectInfo object12 =
			objectInfo("68cb1f232964f3cd698afc1dafe583937203c587", OBJ_COMMIT,
					12);
	private final PackedObjectInfo object556 =
			objectInfo("c5ab27309491cf641eb11bb4b7a78641f280b482", OBJ_TREE,
					556);
	...
	public void setUp() throws Exception {
		...
		smallReverseIndex = PackReverseIndex.read(smallIn, 6,
	...
	private static PackedObjectInfo objectInfo(String objectId, int type,
			long offset) {
		PackedObjectInfo objectInfo =
				new PackedObjectInfo(ObjectId.fromString(objectId));
