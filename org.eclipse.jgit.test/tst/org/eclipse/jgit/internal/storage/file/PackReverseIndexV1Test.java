...
public class PackReverseIndexV1Test {
	...
	public void setUp() throws Exception {
		...
		smallReverseIndex = PackReverseIndexFactory.read(smallIn, 6,
		...
		emptyReverseIndex = PackReverseIndexFactory.read(emptyIn, 0,
				() -> null);
	}
	...
	public void read_objectCountTooLarge() {
		...
		assertThrows(IllegalArgumentException.class,
				() -> PackReverseIndexFactory.read(dummyInput, biggerThanInt,
						() -> null));
	}
	...
	public void verifyChecksum_mismatch() throws IOException {
		...
		when(mockForwardIndex.getChecksum()).thenReturn(
				new byte[] { 'D', 'I', 'F', 'F', 'P', 'A', 'C', 'K', 'C', 'H',
						'E', 'C', 'K', 'S', 'U', 'M', '7', '8', '9', '0', });
		PackReverseIndex reverseIndex = PackReverseIndexFactory.read(in, 0,
				() -> mockForwardIndex);
