...
public class GcReverseIndexTest extends GcTestCase {
	...
	private static void assertValidExists(FileRepository repo)
			throws Exception {
	...
	private static void assertDoesNotExist(FileRepository repo) {
