...
public class PackWriterTest extends SampleDataRepositoryTestCase {
	...
	/**
	 * Creates objects and packfiles in the following order: * Creates 2 objects
	 * (C1 = commit, T1 = tree) * Creates packfile P1 (containing C1, T1) *
	 * Creates 1 object (C2 commit) * Creates packfile P2 (containing C1, T1,
	 * C2) * Create 1 object (C3 commit)
	 *
	 * @throws Exception
	 */
