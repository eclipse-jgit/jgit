...
/**
 * Test MIDXLoader by reading the multi-pack-index file generated by Cgit.
 */
public class MIDXLoaderTest {
    ...
    public void readMIDXV1() throws Exception {
        ...
        assertEquals(PACKFILE_NAMES, midx.getPackFileNames());

        MIDX.ObjectOffset oo = midx.getObjectOffset(ObjectId.fromString("3f4ee50f784c1e9550f09a67d2ffc1bc76917bdc"));
