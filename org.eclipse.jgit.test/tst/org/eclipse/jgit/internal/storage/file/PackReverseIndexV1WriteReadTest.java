...
public class PackReverseIndexV1WriteReadTest {
	...
	public void writeThenRead_noObjects() throws IOException {
		...
		// read
		PackReverseIndex noObjectsReverseIndex = PackReverseIndex.read(in, 0, () -> null);

		// use
		assertThrows(AssertionError.class, () -> noObjectsReverseIndex.findObjectByPosition(0));
	}
	...
	public void writeThenRead_oneObject() throws IOException {
		...
		// read
		PackReverseIndex oneObjectReverseIndex = PackReverseIndex.read(in, 1, () -> mockForwardIndex);
	...
	public void writeThenRead_multipleObjectsLargeOffsets() throws IOException {
		...
		// read
		PackReverseIndex multipleObjectsReverseIndex = PackReverseIndex.read(in, 5, () -> mockForwardIndex);
