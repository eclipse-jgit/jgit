...
public class PackReverseIndexV1WriteReadTest {
	...
	public void writeThenRead_noObjects() throws IOException {
		...
		PackReverseIndexWriter writer =
				PackReverseIndexWriter.createWriter(out, 1);
		...
		// read
		PackReverseIndex noObjectsReverseIndex =
	...
	public void writeThenRead_oneObject() throws IOException {
		...
		// read
		PackReverseIndex oneObjectReverseIndex =
				PackReverseIndex.read(in, 1, () -> mockForwardIndex);
	...
	public void writeThenRead_multipleObjectsLargeOffsets() throws IOException {
		...
		// read
		PackReverseIndex multipleObjectsReverseIndex =
				PackReverseIndex.read(in, 5, () -> mockForwardIndex);
