...
public class MultiPackIndexBuilderTest {
    ...
    public void testRepeatedChunk() throws Exception {
        ...
        builder4.addPackFileNames(buffer);
        ...
        builder5.addBitmappedPackfiles(buffer);
        ...
        builder7.addBitmapPackOrder(buffer);
    ...
    public void testNeededChunk() {
        ...
        Exception e2 = assertThrows(MultiPackIndexFormatException.class, () -> {
            MultiPackIndexBuilder.builder().addOidFanout(buffer).addOidLookUp(buffer).build();
        });
        ...
        Exception e3 = assertThrows(MultiPackIndexFormatException.class, () -> {
            MultiPackIndexBuilder.builder().addOidFanout(buffer).addOidLookUp(buffer).addPackFileNames(buffer).build();
        });
