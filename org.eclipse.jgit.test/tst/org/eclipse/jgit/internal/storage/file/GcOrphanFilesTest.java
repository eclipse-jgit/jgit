...
public class GcOrphanFilesTest extends GcTestCase {
	...
	private static final String REVERSE_File_2 = PACK + "-2." + REVERSE_INDEX.getExtension();

	private static final String REVERSE_File_4 = PACK + "-4." + REVERSE_INDEX.getExtension();
