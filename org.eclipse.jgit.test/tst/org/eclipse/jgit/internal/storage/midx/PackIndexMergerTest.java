...
public class PackIndexMergerTest {
	...
	@Test
	public void merger_noDuplicates() {
		...
		Iterator<PackIndexMerger.MutableEntry> it = merger.bySha1Iterator();
	...
	@Test
	public void merger_allDuplicates() {
		PackIndex idxOne = FakeIndexFactory.indexOf(List.of(
				new IndexObject("0000000000000000000000000000000000000001",
						500),
				new IndexObject("0000000000000000000000000000000000000005", 12),
	...
	@Test
	public void merger_differentIndexSizes() {
	...
	@Test
	public void merger_largeOffsets_needsChunk() {
	...
	@Test
	public void merger_largeOffsets_noChunk() {
	...
	private static void assertNextEntry(
			Iterator<PackIndexMerger.MutableEntry> it, String oid, int packId,
			long offset) {
		assertTrue(it.hasNext());
		PackIndexMerger.MutableEntry e = it.next();
