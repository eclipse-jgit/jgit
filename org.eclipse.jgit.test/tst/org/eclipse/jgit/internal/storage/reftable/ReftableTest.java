...
public class ReftableTest {
	...
	public void seekPastWithSeekRefsWithPrefix() throws IOException {
		...
		try (RefCursor rc = t.seekRefsWithPrefix("refs/heads/")) {
			...
			// NOT_REF_HEADS is next, but it's omitted because of seekRefsWithPrefix("refs/heads/").
			assertFalse(rc.next());
		}
	}
	...
	public void skipPastRefWithLastUTF8() throws IOException {
		ReftableReader t = read(write(ref(String.format("refs/heads/%sbla", new String(LAST_UTF8_CHAR, UTF_8)), 1)));
