...
public class GcCommitSelectionTest extends GcTestCase {
	...
	@Test
	public void testShouldNotGenerateBitmapWhenInFlightPacksExistByDefault()
			throws Exception {
		// Generate a PackFile
		createNewCommitOnNewBranch("main");
		gc.gc().get();
	...
	@Test
	public void testShouldNotGenerateBitmapWhenInFlightPacksExistIsFalse()
			throws Exception {
		PackConfig packConfig = new PackConfig();
	...
	@Test
	public void testShouldNotGenerateBitmapWhenInFlightPacksExistIsTrue()
			throws Exception {
		PackConfig packConfig = new PackConfig();
