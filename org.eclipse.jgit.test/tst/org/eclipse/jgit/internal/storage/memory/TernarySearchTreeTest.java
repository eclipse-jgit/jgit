...
public class TernarySearchTreeTest {
	...
	public void testReplace() {
		TernarySearchTree<String> newTree = new TernarySearchTree<>();
		newTree.insert("foo", "foo-value");
		newTree.insert("bar", "bar-value");
		TernarySearchTree<String> trie2 = TernarySearchTree.replace(tree, newTree);
		assertArrayEquals(new String[] { "bar", "foo" },
				toArray(trie2.getKeys()));
		assertArrayEquals(new String[0], toArray(tree.getKeys()));
	}
	...
	public void testGetKeysWithPrefix() {
		...
		assertArrayEquals(new String[0], toArray(tree.getKeysWithPrefix("")));
