...
public class CommitGraphLoaderTest {
	...
	public void readCommitGraphV1() throws Exception {
		commitGraph = CommitGraphLoader.open(
				JGitTestUtil.getTestResourceFile("commit-graph.v1"),
	...
	@Test
	public void checkBloomFilterExistence() throws Exception {
		commitGraph = CommitGraphLoader.open(
				JGitTestUtil
						.getTestResourceFile("commit-graph-with-bloom-filters"),
