...
public class PackExtBlockCacheTableTest {
	...
	public void hasBlock0CallsPackExtCacheTable() {
		...
		PackExtBlockCacheTable tables = PackExtBlockCacheTable
				.fromCacheTables(defaultBlockCacheTable, List
						.of(new PackExtBlockCacheTable.PackExtsCacheTablePair(
	...
	public void getBlockCacheStatsGetCurrentSizeConsolidatesAllTableCurrentSizes() {
		...
		PackExtBlockCacheTable tables = PackExtBlockCacheTable
				.fromCacheTables(cacheTableWithStats(packStats), List.of(
						new PackExtBlockCacheTable.PackExtsCacheTablePair(Set
								.of(PackExt.BITMAP_INDEX),
