...
public class DfsObjDatabaseTest {
	...
	@Test
	public void getPackList_allInMidx_midxEnabled() throws IOException {
		db.getObjectDatabase().setUseMultipackIndex(true);

		DfsPackDescription gcPack = pack("aaaa", GC_PART, 100, PACK);
	...
	@Test
	public void getPackList_allInMidx_midxDisabled() throws IOException {
    ...
    @Test
	public void getPackList_someInMidx_midxEnabled() throws IOException {
		db.getObjectDatabase().setUseMultipackIndex(true);
	...
	@Test
	public void getPackList_someInMidx_midxDisabled() throws IOException {
		db.getObjectDatabase().setUseMultipackIndex(false);
    ...
    @Test
	public void getPackList_midxTree_midxEnabled() throws IOException {
		db.getObjectDatabase().setUseMultipackIndex(true);
	...
	@Test
	public void getPackList_midxTree_midxDisabled() throws IOException {
		db.getObjectDatabase().setUseMultipackIndex(false);
