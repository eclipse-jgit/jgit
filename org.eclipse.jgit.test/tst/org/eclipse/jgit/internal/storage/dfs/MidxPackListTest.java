...
public class MidxPackListTest {
	...
	@Test
	public void getMidxPacks_onlyPlain() throws IOException {
		setupThreePacks();

		MidxPackList packList = MidxPackList
				.create(db.getObjectDatabase().getPacks());
		assertEquals(0, packList.getMidxPacks().size());
	}

	@Test
	public void getMidxPacks_onlyMidx() throws IOException {
		setupThreePacksAndMidx();

		MidxPackList packList = MidxPackList
				.create(db.getObjectDatabase().getPacks());
		assertEquals(1, packList.getMidxPacks().size());
	}

	@Test
	public void getMidxPacks_midxPlusOne() throws IOException {
		setupThreePacksAndMidx();
		writePackWithRandomBlob(60);
	...
	@Test
	public void getMidxPacks_nestedMidx() throws IOException {
		setupSixPacksThreeMidx();

		DfsPackFile[] packs = db.getObjectDatabase().getPacks();
		assertEquals(1, packs.length);
		MidxPackList packList = MidxPackList.create(packs);
		assertEquals(3, packList.getMidxPacks().size());
	}
