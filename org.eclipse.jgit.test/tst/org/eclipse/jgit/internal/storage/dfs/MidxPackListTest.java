...
public class MidxPackListTest {
	...
	@Test
	public void getTopMidxPack_multipleMidx_biggerByObjectCount()
			throws IOException {
	...
	@Test
	public void getTopMidxPack_multipleMidx_sameCountShorterChain()
			throws IOException {
		writePackWithRandomBlob(100);
		writePackWithRandomBlob(300);
		writePackWithRandomBlob(50);
		...
		// midx covers all packs
		DfsPackFileMidx fullCoverageMidx = writeMultipackIndex(
				Arrays.copyOfRange(packs, 0, 6), null);
		...
		MidxPackList packList = MidxPackList
				.create(db.getObjectDatabase().getPacks());
		assertEquals(fullCoverageMidx.getPackDescription(),
				packList.getTopMidxPack().getPackDescription());
	}
