...
import org.eclipse.jgit.internal.storage.dfs.DfsPackExtBlockCacheTables.PackExtsCacheTablePair;
...
public class DfsPackExtBlockCacheTablesTest {
	...
	public void fromBlockCacheConfigsCreatesDfsPackExtBlockCacheTables() {
		...
		DfsPackExtBlockCacheTables.fromBlockCacheConfigs(cacheConfig);
	}
	...
	public void fromBlockCacheConfigsFailsNoPackExtConfigurationGivenWhenPackExtCacheConfigurationsIsEmpty() {
		...
		assertThrows(IllegalArgumentException.class,
				() -> DfsPackExtBlockCacheTables.fromBlockCacheConfigs(config));
	}

	@Test
	public void fromCacheTablesFailsWithDuplicatePackExts() {
		assertThrows(IllegalArgumentException.class,
				() -> DfsPackExtBlockCacheTables.fromCacheTables(
	...
	@Test
	public void hasBlock0CallsPackExtCacheTable() {
		...
		DfsPackExtBlockCacheTables tables = DfsPackExtBlockCacheTables
				.fromCacheTables(defaultBlockCacheTable, List.of(
						new DfsPackExtBlockCacheTables.PackExtsCacheTablePair(
	...
	@Test
	public void hasBlock0CallsDefaultCache() {
	...
	@Test
	public void getOrLoadCallsPackExtCacheTable() throws Exception {
	...
	@Test
	public void getOrLoadCallsDefaultCache() throws Exception {
		BlockBasedFile blockBasedFile = new BlockBasedFile(null,
	...
	@Test
	public void getOrLoadRefCallsPackExtCacheTable() throws Exception {
	...
	@Test
	public void getOrLoadRefCallsDefaultCache() throws Exception {
		Ref<Integer> ref = mock(Ref.class);
	...
	@Test
	public void putDfsBlockCallsPackExtCacheTable() {
		DfsStreamKey dfsStreamKey = new TestKey(PackExt.BITMAP_INDEX);
	...
	@Test
	public void putDfsBlockCallsDefaultCache() {
		DfsStreamKey dfsStreamKey = new TestKey(PackExt.PACK);
		DfsBlock dfsBlock = new DfsBlock(dfsStreamKey, 0, new byte[0]);
		DfsBlockCacheTable defaultBlockCacheTable = mock(
				DfsBlockCacheTable.class);
	...
	@Test
	public void putDfsStreamKeyCallsPackExtCacheTable() {
		DfsStreamKey dfsStreamKey = new TestKey(PackExt.BITMAP_INDEX);
		Ref<Integer> ref = mock(Ref.class);
		DfsBlockCacheTable defaultBlockCacheTable = mock(
				DfsBlockCacheTable.class);
	...
	@Test
	public void putDfsStreamKeyCallsDefaultCache() {
		DfsStreamKey dfsStreamKey = new TestKey(PackExt.PACK);
		Ref<Integer> ref = mock(Ref.class);
		DfsBlockCacheTable defaultBlockCacheTable = mock(
				DfsBlockCacheTable.class);
	...
	@Test
	public void putRefCallsPackExtCacheTable() {
		DfsStreamKey dfsStreamKey = new TestKey(PackExt.BITMAP_INDEX);
		Ref<Integer> ref = mock(Ref.class);
		DfsBlockCacheTable defaultBlockCacheTable = mock(
				DfsBlockCacheTable.class);
	...
	@Test
	public void putRefCallsDefaultCache() {
		DfsStreamKey dfsStreamKey = new TestKey(PackExt.PACK);
		Ref<Integer> ref = mock(Ref.class);
		DfsBlockCacheTable defaultBlockCacheTable = mock(
				DfsBlockCacheTable.class);
	...
	@Test
	public void containsCallsPackExtCacheTable() {
		DfsStreamKey streamKey = new TestKey(PackExt.BITMAP_INDEX);
		DfsBlockCacheTable defaultBlockCacheTable = mock(
				DfsBlockCacheTable.class);
	...
	@Test
	public void containsCallsDefaultCache() {
		DfsStreamKey streamKey = new TestKey(PackExt.PACK);
		DfsBlockCacheTable defaultBlockCacheTable = mock(
				DfsBlockCacheTable.class);
		when(defaultBlockCacheTable.contains(any(DfsStreamKey.class),
	...
	@Test
	public void getCallsPackExtCacheTable() {
		DfsStreamKey dfsStreamKey = new TestKey(PackExt.BITMAP_INDEX);
		Ref<Integer> ref = mock(Ref.class);
		DfsBlockCacheTable defaultBlockCacheTable = mock(
				DfsBlockCacheTable.class);
	...
	@Test
	public void getCallsDefaultCache() {
		DfsStreamKey dfsStreamKey = new TestKey(PackExt.PACK);
		Ref<Integer> ref = mock(Ref.class);
		DfsBlockCacheTable defaultBlockCacheTable = mock(
				DfsBlockCacheTable.class);
	...
	@Test
	public void getBlockCacheStatsHasLabel() {
		DfsPackExtBlockCacheTables tables = DfsPackExtBlockCacheTables
				.fromCacheTables(mock(DfsBlockCacheTable.class), List.of(
						new DfsPackExtBlockCacheTables.PackExtsCacheTablePair(
								Set.of(PackExt.INDEX),
								mock(DfsBlockCacheTable.class))));

		assertEquals("INDEX-DfsPackExtBlockCacheTables", tables.getBlockCacheStats().getLabel());
	}

	@Test
	public void getAllBlockCacheStats() {
		DfsBlockCacheTable defaultTable = cacheTableWithStats(
				cacheStatsWithLabel("default table"));
		DfsBlockCacheTable indexTable = cacheTableWithStats(
				cacheStatsWithLabel("index table"));
		DfsBlockCacheTable bitmapTable = cacheTableWithStats(
				cacheStatsWithLabel("bitmap table"));
		DfsPackExtBlockCacheTables tables = DfsPackExtBlockCacheTables
				.fromCacheTables(defaultTable, List.of(
						new DfsPackExtBlockCacheTables.PackExtsCacheTablePair(
								Set.of(PackExt.INDEX), indexTable),
						new DfsPackExtBlockCacheTables.PackExtsCacheTablePair(
								Set.of(PackExt.BITMAP_INDEX), bitmapTable)));

		assertThat(tables.getAllCachesBlockCacheStats().stream()
				.map(BlockCacheStats::getLabel).collect(Collectors.toList()),
				hasItems("default table", "index table",
						"bitmap table"));
	}
	...
	public void getBlockCacheStatsGetCurrentSizeConsolidatesAllTableCurrentSizes() {
		...
		DfsPackExtBlockCacheTables tables = DfsPackExtBlockCacheTables
				.fromCacheTables(cacheTableWithStats(packStats), List.of(
						new DfsPackExtBlockCacheTables.PackExtsCacheTablePair(
								Set.of(PackExt.BITMAP_INDEX),
	...
	private static BlockCacheStats cacheStatsWithLabel(String label) {
		BlockCacheStats stats = mock(BlockCacheStats.class);
		when(stats.getLabel()).thenReturn(label);
		return stats;
	}
