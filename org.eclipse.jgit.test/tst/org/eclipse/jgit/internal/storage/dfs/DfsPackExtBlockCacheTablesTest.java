...
public class DfsPackExtBlockCacheTablesTest {
	@Test
	public void fromPackExtCacheConfigsCreatesDfsPackExtBlockCacheTables() {
		...
		DfsPackExtBlockCacheTables unused = DfsPackExtBlockCacheTables
				.fromPackExtCacheConfigs(cacheConfig);
	}

	@Test
	public void fromCacheTablesFailsNoPackExtConfigurationGivenWhenPackExtCacheConfigurationsIsNull() {
		assertThrows(IllegalArgumentException.class,
				() -> DfsPackExtBlockCacheTables
						.fromPackExtCacheConfigs(new DfsBlockCacheConfig()));
	}

	@Test
	public void fromCacheTablesFailsNoPackExtConfigurationGivenWhenPackExtCacheConfigurationsIsEmpty() {
		DfsBlockCacheConfig config = new DfsBlockCacheConfig();
		config.setPackExtCacheConfigurations(List.of());
		assertThrows(IllegalArgumentException.class,
				() -> DfsPackExtBlockCacheTables
						.fromPackExtCacheConfigs(config));
	}
	...
	public void getBlockCacheStatsGetMissCountConsolidatesAllTableMissCounts() {
		...
		DfsBlockCacheStats indexStats = new DfsBlockCacheStats();
		incrementCounter(7,
				() -> packStats.incrementMiss(new TestKey(PackExt.INDEX)));
	...
	public void getBlockCacheStatsGetTotalRequestCountConsolidatesAllTableTotalRequestCounts() {
		...
		DfsBlockCacheStats bitmapStats = new DfsBlockCacheStats();
		incrementCounter(6, () -> {
			packStats.incrementHit(new TestKey(PackExt.BITMAP_INDEX));
			packStats.incrementMiss(new TestKey(PackExt.BITMAP_INDEX));
		});
	...
	public void getBlockCacheStatsGetEvictionsConsolidatesAllTableEvictions() {
		...
		DfsBlockCacheStats indexStats = new DfsBlockCacheStats();
		incrementCounter(7,
				() -> packStats.incrementEvict(new TestKey(PackExt.INDEX)));
