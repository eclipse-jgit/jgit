...
public class RevWalkCommitGraphTest extends RevWalkTestCase {
	...
	public void testChangedPathFilterMergeCommit_disabled() throws Exception {
		...
		RevCommit merge2 = commit(tree(file("file1", blob("1"))), merge1, root3);
	...
	@Test
	public void testChangedPathFilterMergeCommit_usedBaseParentAsRewrite() throws Exception {
		RevCommit root1 = commit(tree(file("file1", blob("1"))));
		RevCommit root2 = commit(tree(file("file1", blob("2"))));
		RevCommit root3 = commit(tree(file("file1", blob("3"))));
		RevCommit merge1 = commit(tree(file("file1", blob("1"))), root1, root2);
		...
		assertEquals(0, rfs.getNumMergeCommitsHadNoDiffWithAnyInterestingParent());
	}

	@Test
	public void testChangedPathFilterMergeCommit_usedPullRequestParentAsRewrite() throws Exception {
		RevCommit root1 = commit(tree(file("file1", blob("1"))));
		RevCommit root2 = commit(tree(file("file1", blob("2"))));
		RevCommit root3 = commit(tree(file("file1", blob("3"))));
		RevCommit merge1 = commit(tree(file("file1", blob("2"))), root1, root2);
		RevCommit merge2 = commit(tree(file("file1", blob("2"))), root3, merge1);
	...
	@Test
	public void testChangedPathFilterMergeCommit_noParentRedirect() throws Exception {
		RevCommit root1 = commit(tree(file("file1", blob("1"))));
		RevCommit root2 = commit(tree(file("file1", blob("2"))));
		RevCommit root3 = commit(tree(file("file1", blob("3"))));
		RevCommit merge1 = commit(tree(file("file1", blob("4"))), root1, root2);
		RevCommit merge2 = commit(tree(file("file1", blob("5"))), root3, merge1);
	...
	@Test
	public void testChangedPathFilterMergeCommit_noInterestingParentForRedirect() throws Exception {
		RevCommit root1 = commit(tree(file("file1", blob("1"))));
		RevCommit root2 = commit(tree(file("file1", blob("2"))));
		...
		RevCommit merge3 = commit(tree(file("file1", blob("1"))), merge1, merge2);
		...
		expectedRevWalk.markStart(expectedRevWalk.lookupCommit(db.resolve("master")));
		...
		RevWalk.RevFilterStats rfs = rw.getRevFilterStats();
		// both merge3 and merge2 had same content base parent but they were UNINTERESTING
		assertEquals(0, rfs.getNumMergeCommitsUsedBaseParentAsRedirect());
		assertEquals(0, rfs.getNumMergeCommitsUsedPullRequestParentAsRedirect());
		assertEquals(0, rfs.getNumMergeCommitsHadNoRedirect());
		assertEquals(2, rfs.getNumMergeCommitsHadNoDiffWithAnyInterestingParent());
	}
	...
	public void testChangedPathFilter() throws Exception {
		...
		TreeRevFilter trf = new TreeRevFilter(rw,
				PathAnyDiffFilter.create("file1"));
		rw.markStart(rw.lookupCommit(c4));
		rw.setRevFilter(trf);
		assertEquals(c4, rw.next());
		assertEquals(c3, rw.next());
	...
	public void testChangedPathFilterWithMultiPaths() throws Exception {
		...
		TreeRevFilter trf = new TreeRevFilter(rw,
				PathAnyDiffFilter.create("file1", "file2"));
		rw.markStart(rw.lookupCommit(c4));
		rw.setRevFilter(trf);
		assertEquals(c4, rw.next());
		assertEquals(c3, rw.next());
	...
	public void testChangedPathFilterWithFollowFilter() throws Exception {
		...
		TreeRevFilter trf = new TreeRevFilter(rw,
				new FollowFilter(PathAnyDiffFilter.create("renamed-file"),
	...
	public void testChangedPathFilter_pathFilter_or_pathFilter_binaryOperation()
		...
		PathAnyDiffFilter pf1 = PathAnyDiffFilter.create("file1");
		PathAnyDiffFilter pf2 = PathAnyDiffFilter.create("file2");

		TreeFilter tf = OrTreeFilter.create(new PathAnyDiffFilter[] { pf1, pf2 });
	...
	public void testChangedPathFilter_pathFilter_or_pathFilter_or_pathFilter_listOperation()
		...
		PathAnyDiffFilter pf1 = PathAnyDiffFilter.create("file1");
		PathAnyDiffFilter pf2 = PathAnyDiffFilter.create("file2");
		PathAnyDiffFilter pf3 = PathAnyDiffFilter.create("file3");

		TreeFilter tf = OrTreeFilter.create(new PathAnyDiffFilter[] { pf1, pf2, pf3 });
	...
	public void testChangedPathFilter_pathFilter_or_nonPathFilter_binaryOperation()
		...
		PathAnyDiffFilter pf = PathAnyDiffFilter.create("file1");
	...
	public void testChangedPathFilter_pathFilter_and_pathFilter_binaryOperation()
		...
		TreeFilter atf = AndTreeFilter.create(new PathAnyDiffFilter[] { pf1, pf2 });
	...
	public void testChangedPathFilter_pathFilter_and_pathFilter_and_pathFilter_listOperation()
		...
		TreeFilter tf = AndTreeFilter
				.create(new PathAnyDiffFilter[] { pf1, pf2, pf3 });
