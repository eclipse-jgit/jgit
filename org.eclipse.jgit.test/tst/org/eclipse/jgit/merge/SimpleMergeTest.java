...
public class SimpleMergeTest extends SampleDataRepositoryTestCase {
	...
	public void testGitLinkMerging_bothAddedDifferentLink() throws Exception {
		testGitLink(null, linkId2, linkId3, false);
	}
