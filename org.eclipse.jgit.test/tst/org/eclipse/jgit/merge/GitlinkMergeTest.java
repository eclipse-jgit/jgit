...
public class GitlinkMergeTest extends SampleDataRepositoryTestCase {
	...
	public void testGitLinkMerging_bothAddedSameLink() throws Exception {
		assertGitLinkValue(
				testGitLink(null, linkId2, linkId2, NORMAL_MERGE_CASE, true),
				linkId2);
	}

	@Test
	public void testGitLinkMerging_bothAddedDifferentLink() throws Exception {
		testGitLink(null, linkId2, linkId3, NORMAL_MERGE_CASE, false);
	}
	...
	public void testGitLinkMerging_UpdateUpdate_ignoreConflicts()
			throws Exception {
		assertGitLinkValue(testGitLink(linkId1, linkId2, linkId3,
				IGNORE_CONFLICTS_CASE, true), linkId2);
	}
	...
	public void testGitLinkMerging_bothAddedSameLink_ignoreConflicts()
			throws Exception {
		assertGitLinkValue(testGitLink(null, linkId2, linkId2,
				IGNORE_CONFLICTS_CASE, true), linkId2);
	}
	...
	private Merger newResolveMerger(boolean ignoreConflicts) {
		...
		return new ResolveMerger(db, true) {
			...
			protected boolean mergeImpl() throws IOException {
				...
				try {
					return mergeTrees(mergeBase(), sourceTrees[0],
							sourceTrees[1], true);
