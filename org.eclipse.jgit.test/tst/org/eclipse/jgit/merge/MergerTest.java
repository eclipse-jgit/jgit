...
public class MergerTest extends RepositoryTestCase {
	...
	public void oursBinaryTheirsBinaryBaseBinary(MergeStrategy strategy)
		...
		// checking if the merge gave a conflict
		...
		// checking if the file content changed during a conflicting merge
	...
	public void fileInBinaryInAttribute(MergeStrategy strategy)
		...
		git.add().addFilepattern(".gitattributes").call();
		git.commit().setMessage("ADDING GITATTRIBUTES")
				.call();
	...
	// gives the hash of a file in the work tree
