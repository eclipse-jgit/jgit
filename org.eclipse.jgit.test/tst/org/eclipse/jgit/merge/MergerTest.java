...
public class MergerTest extends RepositoryTestCase {
	...
	/**
	 * This is a high-level test for https://git.eclipse.org/r/c/jgit/jgit/+/194366
	 *
	 * The actual fix was made in {@link org.eclipse.jgit.treewalk.NameConflictTreeWalk}
	 * and tested in {@link NameConflictTreeWalkTest#tesdDF_LastItemsInTreeHasDFConflictAndSpecialNames}.
	 */
	@Theory
	public void checkMergeDoesntCrashWithSpecialFileNames(MergeStrategy strategy)
			throws Exception {
		Git git = Git.wrap(db);
		...
		ResolveMerger merger = (ResolveMerger) strategy.newMerger(db, false);
		assertTrue(merger.merge(new AnyObjectId[] {mergeTip, toMerge}));
	}
