...
public class OrTreeFilterTest {
	...
	@Test
	public void testMaybeMatch_NonPathFilter_Or_PathFilter_Match() {
		String[] path = { "path1" };
		...
		assertEquals(opf.maybeMatch(cpfContainModified),
				TreeFilter.ChangedPathFilterMatch.TRUE);
		assertEquals(opf.maybeMatch(cpfWithoutPath),
				TreeFilter.ChangedPathFilterMatch.TRUE);
	}

	@Test
	public void testMaybeMatch_PathFilter_Or_PathFilter_Match() {
		String[] path = { "path1" };
		ChangedPathFilter cpfContainModified = cpf(path);
		...
		assertEquals(opf.maybeMatch(cpfContainModified),
				TreeFilter.ChangedPathFilterMatch.TRUE);
		assertEquals(opf.maybeMatch(cpfContainModified2),
				TreeFilter.ChangedPathFilterMatch.TRUE);
	}

	@Test
	public void testMaybeMatch_PathFilter_Or_PathFilter_NoMatch() {
		String[] path3 = { "path4" };
		ChangedPathFilter cpfContainModified3 = cpf(path3);

		TreeFilter opf = OrTreeFilter.create(PathFilter.create("path1"),
				PathFilter.create("path2"));
		assertEquals(opf.maybeMatch(cpfContainModified3),
				TreeFilter.ChangedPathFilterMatch.FALSE);
	}

	@Test
	public void testMaybeMatch_NonPathFilter_Or_NonPathFilter_NotApplicable() {
		String[] path = { "path1" };
		ChangedPathFilter cpfContainModified = cpf(path);
		...
		TreeFilter opf = OrTreeFilter.create(TreeFilter.ANY_DIFF,
				TreeFilter.ANY_DIFF);
		assertEquals(opf.maybeMatch(cpfContainModified),
				TreeFilter.ChangedPathFilterMatch.NOT_APPLICABLE);
	}

	@Test
	public void testMaybeMatch_NonPathFilter_Or_PathFilter_Or_NonPathFilter_Match() {
		String[] path = { "path1" };
		ChangedPathFilter cpfContainModified = cpf(path);
	...
	@Test
	public void testMaybeMatch_PathFilter_Or_NonPathFilter_Or_PathFilter_Match() {
	...
	@Test
	public void testMaybeMatch_PathFilter_Or_PathFilter_Or_PathFilter_Match() {
	...
	@Test
	public void testMaybeMatch_PathFilter_Or_PathFilter_Or_PathFilter_NoMatch() {
		String[] path4 = { "path4" };
	...
	@Test
	public void testMaybeMatch_NonPathFilter_Or_NonPathFilter_Or_NonPathFilter_NotApplicable() {
		String[] path = { "path1" };
		ChangedPathFilter cpfContainModified = cpf(path);
		...
		assertEquals(apf.maybeMatch(cpfContainModified),
				TreeFilter.ChangedPathFilterMatch.NOT_APPLICABLE);
	}
