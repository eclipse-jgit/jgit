...
public class AndTreeFilterTest {
	...
	@Test
	public void testMaybeMatch_NonPathFilter_And_PathFilter_Match() {
		String[] path = { "path1" };
	...
	@Test
	public void testMaybeMatch_NonPathFilter_And_PathFilter_NoMatch() {
		String[] wrongPath = { "path3", "path4" };
		ChangedPathFilter cpfWithoutPath = cpf(wrongPath);

		TreeFilter apf = AndTreeFilter.create(TreeFilter.ANY_DIFF,
				PathFilter.create("path1"));
		assertEquals(apf.maybeMatch(cpfWithoutPath),
				TreeFilter.ChangedPathFilterMatch.FALSE);
	}

	@Test
	public void testMaybeMatch_PathFilter_And_PathFilter_Always_NoMatch() {
		String[] path = { "path1" };
		ChangedPathFilter cpfContainModified = cpf(path);
	...
	@Test
	public void testMaybeMatch_NonPathFilter_And_NonPathFilter_Always_NotApplicable() {
		String[] path = { "path1" };
		ChangedPathFilter cpfContainModified = cpf(path);
	...
	@Test
	public void testMaybeMatch_NonPathFilter_And_PathFilter_And_NonPathFilter_Match() {
		String[] path = { "path1" };
		ChangedPathFilter cpfContainModified = cpf(path);
	...
	@Test
	public void testMaybeMatch_NonPathFilter_And_PathFilter_And_NonPathFilter_NoMatch() {
		String[] wrongPath = { "path3", "path4" };
		ChangedPathFilter cpfWithoutPath = cpf(wrongPath);
	...
	@Test
	public void testMaybeMatch_PathFilter_And_NonPathFilter_And_PathFilter_NoMatch() {
	...
	@Test
	public void testMaybeMatch_PathFilter_And_PathFilter_And_PathFilter_NoMatch() {
	...
	@Test
	public void testMaybeMatch_NonPathFilter_And_NonPathFilter_And_NonPathFilter_NotApplicable() {
		String[] path = { "path1" };
		ChangedPathFilter cpfContainModified = cpf(path);
