...
public class PathFilterGroupTest {
	...
	@Test
	public void testCheckPath_Single() {
		String[] path = { "path1" };
		...
		assertEquals(pathFilterGroup.checkPath(cpfWithPath),
				TreeFilter.ChangedPathFilterResponse.POSITIVE);
		assertEquals(pathFilterGroup.checkPath(cpfWithoutPath),
				TreeFilter.ChangedPathFilterResponse.NEGATIVE);
	}

	@Test
	public void testCheckPath_Group() {
