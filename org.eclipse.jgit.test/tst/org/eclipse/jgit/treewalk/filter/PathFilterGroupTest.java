...
public class PathFilterGroupTest {
	...
	@Test
	public void testMaybeMatch_Single() {
		String[] path = { "path1" };
		...
		assertEquals(pathFilterGroup.maybeMatch(cpfContainModified),
				TreeFilter.ChangedPathFilterMatch.TRUE);
		assertEquals(pathFilterGroup.maybeMatch(cpfWithoutPath),
				TreeFilter.ChangedPathFilterMatch.FALSE);
	}

	@Test
	public void testMaybeMatch_Group() {
