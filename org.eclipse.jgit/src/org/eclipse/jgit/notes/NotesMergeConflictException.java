...
public class NotesMergeConflictException extends IOException {
	 ...
	 *            version of the root note tree
	 */
	public NotesMergeConflictException(InMemoryNoteBucket base,
			InMemoryNoteBucket ours, InMemoryNoteBucket theirs) {
		super(MessageFormat.format(JGitText.get().mergeConflictOnNoNoteEntries,
				base.getTreeId(), ours.getTreeId(), theirs.getTreeId()));
	}
