...
public class Applier implements InCoreSupport {
  ...
  private void apply(String path, DirCache cache,
      File f, org.eclipse.jgit.patch.FileHeader fh) throws PatchApplyException {
    ...
    try {
      ...
      inCoreHandler.update(fh.getOldId().toObjectId(), resultStreamLoader, builder, checkOutMetadata, fh.getNewPath(), f,
          safeWrite, fileMode);
  ...
  private StreamLoader applyBinary(String path,
      File f, org.eclipse.jgit.patch.FileHeader fh, InCoreHandler.StreamSupplier inputSupplier, ObjectId id)
      throws PatchApplyException, IOException {
