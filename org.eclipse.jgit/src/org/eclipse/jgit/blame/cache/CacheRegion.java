...
public class CacheRegion implements Serializable, Comparable<CacheRegion> {
	 ...
	 * @param commit commit that is modifying this region
	 * @param author author for the commit modifying this region
	 * @param start first line of this region (inclusive)
	 * @param end last line of this region (non-inclusive!)
	 */
