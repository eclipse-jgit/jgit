...
public class BlameGenerator implements AutoCloseable {
	...
	private final BlameGeneratorStats blameGeneratorStats;
	...
	public static class BlameGeneratorStats {
		 ...
		 * @since 7.0
		 */
		private void incrementChangedPathFilterTruePositive() {
		 ...
		 * @since 7.0
		 */
		private void incrementChangedPathFilterFalsePositive() {
		 ...
		 * @since 7.0
		 */
		private void incrementChangedPathFilterNegative() {
		 ...
		 * @since 7.0
		 */
		private void incrementNumCandidatesThroughBlameGenerator() {
		 ...
		 * @since 7.0
		 */
		private void incrementNumTreesParsedInBlameGenerator(int numTrees) {
		 ...
		 * @since 7.0
		 */
		private void incrementNumBlobsParsedInBlameGenerator() {
