...
public class DiffTools {
	...
	public ExecutionResult compare(FileElement localFile,
			...
			Optional<Boolean> prompt, Optional<Boolean> gui,
	...
	public String getDefaultToolName(Optional<Boolean> gui) {
		return gui.isPresent() ? config.getDefaultGuiToolName()
	...
	private ExternalDiffTool guessTool(String toolName, Optional<Boolean> gui)
			throws ToolException {
