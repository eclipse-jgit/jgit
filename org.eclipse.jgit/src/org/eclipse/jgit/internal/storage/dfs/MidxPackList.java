...
public final class MidxPackList {
	 ...
	 *
	 * <p>
	 * In the unlikely case of multiple unconnected midxs, it takes the longest
	 * chain.
	 *
	 * @return top midx (tip of the longest chain of midxs)
	 */
	public DfsPackFileMidx getTopMidxPack() {
		...
		Optional<DfsPackFileMidx> longest = topLevelMidxs.stream()
				.max(Comparator.comparingInt(MidxPackList::getMidxChainDepth));
