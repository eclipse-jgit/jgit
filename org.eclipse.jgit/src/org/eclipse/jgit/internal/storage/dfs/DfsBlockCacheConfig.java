...
public class DfsBlockCacheConfig {
	...
	/**
	 * Get the map to override default hit count for {@code DfsBlockCache}.
	 *
	 * @return map to override default hit count for {@code DfsBlockCache}.
	 */
	...
	/**
	 * Set the map to override default hit count for {@code DfsBlockCache}.
	 *
	 * @param cacheHitOverrideMap
	 *            map to override default hit count for {@code DfsBlockCache}.
	 * @return {@code this}
	 */
