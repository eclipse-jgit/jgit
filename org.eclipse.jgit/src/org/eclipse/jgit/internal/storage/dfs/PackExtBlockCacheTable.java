...
class PackExtBlockCacheTable implements DfsBlockCacheTable {
	 ...
	 * @param tableFactory
	 *            factory that takes a {@link DfsBlockCacheConfig} and returns a
	 *            configured {@link DfsBlockCacheTable}.
	...
	static PackExtBlockCacheTable fromBlockCacheConfigs(
			...
			DfsCacheTableFactory tableFactory) {
		DfsBlockCacheTable defaultTable = tableFactory.create(cacheConfig);
		...
		for (DfsBlockCachePackExtConfig packExtCacheConfig : packExtConfigs) {
			DfsBlockCacheTable table = tableFactory
					.create(packExtCacheConfig.getPackExtCacheConfiguration());
