...
public class MultiPackIndexV1 implements MultiPackIndex {
	...
	MultiPackIndexV1(int hashLength, @NonNull byte[] oidFanout,
			...
			byte[] bitmappedPackfiles, byte[] objectOffsets, byte[] largeObjectOffsets)
		...
		this.offsets = new Offsets(objectOffsets, largeObjectOffsets);
	...
	/**
	 * Wraps the byte[] with the list of offsets (OOFF chunck)
	 */
	private static class Offsets {
		 ...
		 */
		public Offsets(@NonNull byte[] offsets, byte[] largeOffsets) {
