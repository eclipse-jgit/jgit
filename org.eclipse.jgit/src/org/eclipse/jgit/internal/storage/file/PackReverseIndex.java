...
public abstract class PackReverseIndex {
	...
	public static PackReverseIndex read(InputStream src, long objectCount,
		...
		case VERSION_1:
			...
			return ri;
		default:
			throw new IOException(MessageFormat.format(JGitText.get().unsupportedPackReverseIndexVersion, version));
		}
	}
	 ...
	 */
	public abstract long findNextOffset(long offset, long maxOffset) throws CorruptObjectException;
