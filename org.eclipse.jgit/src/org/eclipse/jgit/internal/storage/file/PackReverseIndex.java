...
public interface PackReverseIndex {
	...
	class PackReverseIndexFactory {
		/**
		 * Create an in-memory pack reverse index by reading it from the given
		 * file if the file exists, or computing it from the given pack index if
		...
		/**
		 * Read an in-memory pack reverse index from the given input stream.
