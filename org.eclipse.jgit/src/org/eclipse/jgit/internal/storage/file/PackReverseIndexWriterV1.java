...
final class PackReverseIndexWriterV1 extends PackReverseIndexWriter {
	...
	protected void writeBody(
			...
			throws IOException {
		int[] indexPositionsSortedByOffset = IntStream
				.range(0, objectsSortedByIndexPosition.size()).boxed()
				.sorted(Comparator.comparingLong(
						indexPosition -> objectsSortedByIndexPosition
								.get(indexPosition.intValue()).getOffset()))
