...
/**
 * A view of a byte[] as a list of ordered integers stored in 3 bytes.
 *
 * The ints are in incremental order and stored in big-endian ("network order"),
 * so byte[]{aa,bb,cc} becomes the int 0x00aabbcc
 */
final class CompactInt3Array {

	public static final CompactInt3Array EMPTY = new CompactInt3Array(
			new byte[0]);
