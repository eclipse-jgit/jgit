...
import static org.eclipse.jgit.internal.storage.file.midx.MultiPackIndexConstants.*;
...
public class MultiPackIndexBuilder {
    ...
    MultiPackIndexBuilder addBitmappedPackfiles(byte[] buffer)
            throws MultiPackIndexFormatException {
        assertChunkNotSeenYet(bitmappedPackfiles, MULTI_PACK_INDEX_BITMAPPED_PACKFILES);
    ...
    MultiPackIndexBuilder addObjectLargeOffsets(byte[] buffer)
            throws MultiPackIndexFormatException {
        assertChunkNotSeenYet(objectLargeOffsets, MULTI_PACK_INDEX_OBJECT_LARGE_OFFSETS);
    ...
    MultiPackIndexBuilder addBitmapPackOrder(byte[] buffer)
            throws MultiPackIndexFormatException {
        assertChunkNotSeenYet(bitmapPackOrder, MULTI_PACK_INDEX_BITMAP_PACK_ORDER);
    ...
    MultiPackIndex build() throws MultiPackIndexFormatException {
        ...
        MultiPackIndexIndex index = new MultiPackIndexIndex(hashLength, oidFanout,
                oidLookup, packFilesCnt);

        return new MultiPackIndexV1(index, packfileNames, bitmappedPackfiles, new ObjectOffsets(objectOffsets));
    }
