...
public class PackBitmapIndexBuilder extends BasePackBitmapIndex {
	...
	private List<StoredBitmap> bitmapsToWrite = new LinkedList<>();
	...
	public List<StoredEntry> getCompressedBitmaps() {
		...
		List<StoredEntry> xorCompressedBitmaps = new LinkedList<>();
		for (int i = 0; i < bitmapsToWrite.size(); i++) {
			bitmapBuffer.add(bitmapsToWrite.get(i)); // this is n^2, fix
