...
public class PackBitmapIndexBuilder extends BasePackBitmapIndex {
	...
	private StoredEntry generateStoredEntry(StoredBitmap bitmapToWrite) {
		...
		bestBitmap.trim();
		StoredEntry result = new StoredEntry(entry, entry.objectIdOffset,
	...
	public static final class StoredEntry {
		private final long objectIdOffset;
		 ...
		 */
		public StoredEntry(ObjectId objectId, long objectIdOffset,
		 ...
		 */
		public long getObjectIdOffset() {
			return objectIdOffset;
		}
	...
	private static final class PositionEntry extends ObjectIdOwnerMap.Entry {
		final int objectIdOffset;

		int packFileOffset;

		PositionEntry(AnyObjectId objectId, int objectIdOffset) {
			super(objectId);
			this.objectIdOffset = objectIdOffset;
		}
	}
