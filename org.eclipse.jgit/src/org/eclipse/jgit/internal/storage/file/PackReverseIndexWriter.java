...
public abstract class PackReverseIndexWriter {
	 ...
	 *
	 * @param dst the OutputStream that the instance will write contents to
	 */
	protected PackReverseIndexWriter(OutputStream dst) {
		out = new DigestOutputStream(dst instanceof BufferedOutputStream ?
				dst :
	...
	/**
	 * Create a new writer instance for the default file format version.
	 *
	 * @param dst the OutputStream that contents will be written to
	...
	/**
	 * Create a new writer instance for the specified file format version.
	 *
	 * @param dst     the OutputStream that contents will be written to
	 * @param version the file format version to write contents as
	 * @return the new writer instance
	 */
	public static PackReverseIndexWriter createWriter(final OutputStream dst,
			final int version) {
	 ...
	 *
	 * @param objectsSortedByIndexPosition the objects whose forward index file
	 *                                     positions should be written, sorted
	 *                                     by forward index file position
	 * @param packChecksum                 the checksum of the corresponding
	 *                                     pack file
