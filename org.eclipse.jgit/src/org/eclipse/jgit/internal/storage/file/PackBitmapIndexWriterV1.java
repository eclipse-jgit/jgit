...
import org.eclipse.jgit.internal.storage.pack.PackWriter.PackBitmapIndexBuilderForWriting.StoredEntry;
...
public class PackBitmapIndexWriterV1 {
	...
	private void writeBody(PackBitmapIndexBuilderForWriting bitmaps)
			throws IOException {
	...
	private void writeBitmaps(PackBitmapIndexBuilderForWriting bitmaps)
			throws IOException {
		int bitmapCount = 0;
