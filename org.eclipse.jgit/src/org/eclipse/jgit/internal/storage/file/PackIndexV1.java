...
class PackIndexV1 implements PackIndex {
	...
	public Iterator<MutableEntry> iterator() {
		return new IndexV1Iterator(this);
	}
	...
	private static class IndexV1Iterator extends EntriesIterator {
		private final MutableEntryV1 entryV1;

		IndexV1Iterator(PackIndexV1 packIndex) {
			super(packIndex.objectCnt);
			this.entryV1 = new MutableEntryV1(packIndex);
		}
