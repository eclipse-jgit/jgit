...
public class Pack implements Iterable<PackIndex.MutableEntry> {
					...
					try {
						...
						if (packChecksum == null) {
							...
							throw new PackMismatchException(
									MessageFormat.format(JGitText.get().packChecksumMismatch, packFile.getPath(),
											PackExt.PACK.getExtension(), Hex.toHexString(packChecksum),
											PackExt.INDEX.getExtension(), Hex.toHexString(idx.packChecksum)));
						}
						loadedIdx = idx;
	...
	private void onOpenPack() throws IOException {
		...
		if (!Arrays.equals(buf, packChecksum)) {
			throw new PackMismatchException(MessageFormat.format(JGitText.get().packChecksumMismatch, getPackFile(),
					PackExt.PACK.getExtension(), Hex.toHexString(buf), PackExt.INDEX.getExtension(),
	...
	private synchronized PackReverseIndex getReverseIdx() throws IOException {
		...
		if (reverseIdx == null) {
			...
			reverseIdx = PackReverseIndex.openOrCompute(reverseIndexFile, getObjectCount(), () -> getIndex());
