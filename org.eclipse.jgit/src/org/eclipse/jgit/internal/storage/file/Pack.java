...
import org.eclipse.jgit.util.Optionally;
...
public class Pack implements Iterable<PackIndex.MutableEntry> {
	 ...
	 */
	public Pack(Config rc, File packFile, @Nullable PackFile bitmapIdxFile) {
		useStrongRefs = rc.getBoolean(CONFIG_CORE_SECTION,
				CONFIG_KEY_PACKED_INDEX_GIT_USE_STRONGREFS, WindowCache.getInstance().useStrongIndexRefs);
	...
	public <T> Optionally<T> optionally(T element) {
