...
public class MultiPackIndexLoader {
     ...
     */
    public static MultiPackIndex open(File midxFile) throws FileNotFoundException,
     ...
     * @throws MultiPackIndexFormatException the MultiPackIndex file's format is different from we expected.
