...
public abstract class RefDatabase {
	 ...
	 * the given prefixes.
	 *
	 * <p> The implementation is not efficient. Implementors of {@link RefDatabase}
	 ...
	 * @return immutable list of refs whose names start with {@code prefix} and non of the strings
	 * 						in {@code exclude}.
	 * @throws java.io.IOException
	 *             the reference space cannot be accessed.
	 * @since 5.9
	 */
	@NonNull
	public List<Ref> getRefsByPrefixWithSkips(Set<String> exclude, String include)
			throws IOException {
