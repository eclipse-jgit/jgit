...
public abstract class PackedRefsWriter {
	...
	/**
	 * <p>Constructor for PackedRefsWriter.</p>
	 *
	 * @param refs
	 ...
	 * <p>Constructor for PackedRefsWriter.</p>
	 *
	 * <p>Stores the provided refs and traits without applying any missing traits.
	 * Intended for use by subclasses that manage trait application themselves.</p>
	 *
	 * @param refs
	 *            the complete set of references. This should have been computed
	 *            by applying updates to the advertised refs already discovered.
