...
public class DelegateRepository extends Repository {
  ...
  protected DelegateRepository(Repository delegate, boolean supportNonBareRepository) {
    super(toBuilder(delegate, supportNonBareRepository));
  ...
  private static BaseRepositoryBuilder toBuilder(Repository repo, boolean supportNonBareRepository) {
    if (!repo.isBare() && !supportNonBareRepository) {
