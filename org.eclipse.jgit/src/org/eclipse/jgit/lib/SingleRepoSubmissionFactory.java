...
public interface SingleRepoSubmissionFactory {
	...
	/**
	 * Returns a handler of a submission. Caller must invoke
	 * {@link OpenSubmission#completed()} when the result of all operations
	 * (success or not) is known.
	 *
	 * @param refUpdates
	 *            reference update to perform in this submission
	 *
