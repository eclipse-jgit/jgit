...
public class MailmapParser {
        ...
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(input))) {
            ...
            while ((line = reader.readLine()) != null) {
                if (!line.startsWith(COMMENT_PREFIX)) {
                    ...
                    if (firstEntry != null) {
                        MailmapResult secondEntry = parseNameAndEmail(firstEntry.restOfLine, true);

                        String newName = firstEntry.name;
                        String newEmail = firstEntry.email;
                        String oldEmail = secondEntry != null ? secondEntry.email : null;
                        String oldName = secondEntry != null ? secondEntry.name : null;
                        ...
                        entries.add(new MailmapEntry(oldName, oldEmail, newName, newEmail));
                    }
    ...
    @Nullable
    private static MailmapResult parseNameAndEmail(String line, boolean allowEmptyEmail) {
        int left, right;
