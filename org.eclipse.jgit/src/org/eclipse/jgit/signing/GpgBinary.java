...
public class GpgBinary {
	...
	/**
	 * Checks if the GPG program can be located.
	 *
	 * @return {@code true} if the GPG program can be found in PATH or exists as
	 *         an absolute path; {@code false} otherwise
	 * @since 7.6
	 */
	public static boolean canLocate() {
		String resolved = get("gpg"); //$NON-NLS-1$
