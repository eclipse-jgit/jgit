...
public class MergeConfig {
	...
	private final FastForwardMode fastfForwardMode;
	...
	private MergeConfig(String branch, Config config) {
		...
		fastfForwardMode = getFastForwardMode(config, mergeOptions);
	...
	private MergeConfig() {
		fastfForwardMode = FastForwardMode.FF;
		squash = false;
		commit = true;
	}
	 ...
	 */
	public FastForwardMode getFastfForwardMode() {
		return fastfForwardMode;
	}
