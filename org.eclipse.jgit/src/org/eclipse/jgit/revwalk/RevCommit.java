...
public class RevCommit extends RevObject {
	 ...
	 * <p>
	 * We use {@value org.eclipse.jgit.lib.CommitGraph#GENERATION_UNKNOWN} to
	 * mark commits not in the commit-graph file. If a commit-graph file was
	 * written without computing generation numbers, then those commits will
	 * have generation number represented by
	 * {@value org.eclipse.jgit.lib.CommitGraph#GENERATION_NOT_COMPUTED}.
	 *
