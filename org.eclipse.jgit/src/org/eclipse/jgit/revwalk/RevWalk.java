...
public class RevWalk implements Iterable<RevCommit>, AutoCloseable {
	...
	/**
	 * Updates the commit in the inmemory's objectId owner map. The newCommit is
	 * added to the front of the linked list in the owners map and hence get
	 * would retrieve that instead of the copy.
	 *
	 * @param newCommit
	 *            new commit
	 */
