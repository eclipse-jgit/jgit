...
public abstract class RenameCallback {
	 ...
	 * file.
	 *
	 * Subclass of this class have to override this to receive diffEntry for the
	 * rename.
	 *
	 * @param entry
	 ...
	 *
	 * Subclass of this class have an option to override this if it wants to
	 * know what commit generated the diffEntry.
	 *
	 * @param entry
	 *            the entry representing the rename/copy
	 * @param commit
