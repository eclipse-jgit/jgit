...
public final class BitmapWalker {
	...
	public interface BitmapWalkListener {
		 ...
		 *
		 * @param oid objectId with a bitmap in the bitmap index
		 */
		 ...
		 *
		 * @param oid objectId without a bitmap in the bitmap index
		 */
	 ...
	 */
	public BitmapWalker (
			ObjectWalk walker, BitmapIndex bitmapIndex, ProgressMonitor pm, BitmapWalkListener listener) {
		this.walker = walker;
