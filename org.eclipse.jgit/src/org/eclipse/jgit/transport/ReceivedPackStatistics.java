...
public class ReceivedPackStatistics {
	...
	/**
	 * Get number of bytes of objects that appeared in both the pack sent by
	...
	/**
	 * Get number of objects appeared in both the pack sent by the client and the
	 * local database
	 *
	 * @return number of objects appeared in both the pack sent by the client and
	 *         local database
	 * @since 5.8
	 */
	...
	public static class Builder {
		...
		/**
		 * @param size number of bytes of an object which appears in the pack
		 *             sent by the client and the local database
		 * @return this
		 * @since 5.8
		 */
		public Builder increaseNumBytesDuplicated(long size) {
