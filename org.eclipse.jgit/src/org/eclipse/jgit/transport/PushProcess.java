...
class PushProcess {
	 ...
	 * @param prePush
	 *            {@link PrePushHook} to run after the remote advertisement as
	 *            been gotten
	 ...
	 * <li>both of then must be known to us and exist in the repository,
	 * AND</li>
	...
	/**
	 * Expands the placeholder {@link RemoteRefUpdate} {gcode match} for a
