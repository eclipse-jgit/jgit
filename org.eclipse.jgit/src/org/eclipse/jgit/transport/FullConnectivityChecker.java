...
final class FullConnectivityChecker implements ConnectivityChecker {
	@Override
	public void checkConnectivity(ReceivePack baseReceivePack,
	 ...
	 */
	private boolean markStartAndKnownNodes(ReceivePack baseReceivePack,
			ObjectWalk ow,
			Set<ObjectId> haves, ProgressMonitor monitor)
			throws IOException {
	 ...
	 *
	 */
	private void checkObjects(ReceivePack baseReceivePack, ObjectWalk ow,
	 ...
	 *             an error occurred during connectivity checking.
	 */
	private void checkCommitTree(ReceivePack baseReceivePack, ObjectWalk ow,
			ProgressMonitor monitor) throws IOException {
		RevCommit c;
