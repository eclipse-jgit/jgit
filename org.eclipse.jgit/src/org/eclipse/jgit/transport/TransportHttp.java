...
public class TransportHttp extends HttpTransport implements WalkTransport,
     ...
     * @throws org.eclipse.jgit.errors.NotSupportedException if URI is not supported by JGit
     * @since 4.9
     */
     ...
     *
     * @param uri URI to create a HTTP transport for
     * @throws NotSupportedException if URI is not supported by JGit
     */
     ...
     * applications.
     *
     * @param on if {@code true} (default), smart HTTP is enabled.
     */
     ...
     * </p>
     *
     * @param customFactory the {@link HttpConnectionFactory} to use
     * @throws IllegalStateException if an HTTP/HTTPS connection has already been opened on this
     *                               {@link TransportHttp} instance
     * @since 5.11
     */
     ...
     *
     * @param headers a map of name:values that are to be set as headers on the HTTP
     *                connection
     * @since 3.4
     */
    ...
    /**
     * @param allCookies a list of cookies.
     * @param url        the url for which to filter the list of cookies.
     ...
     * </ul>
     *
     * @param host         the host to compare against the cookieDomain
     * @param cookieDomain the domain to compare against
