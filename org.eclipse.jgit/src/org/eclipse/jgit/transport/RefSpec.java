...
public class RefSpec implements Serializable {
	 ...
	 * <p>
	 * RefSpecs can be regular or negative, regular RefSpecs indicate what to
	 * include in transport operations while negative RefSpecs indicate what to
	 * exclude in fetch.
	 * <p>
	 * Negative RefSpecs can't be force, must have only source or destination.
	 * Wildcard patterns are also supported in negative RefSpecs but they can
	 * not go with {@link WildcardMode.REQUIRE_MATCH} because they are natually
