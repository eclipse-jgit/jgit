...
import org.eclipse.jgit.patch.Applier.ApplyPatchResult;
...
public class ApplyCommand extends GitCommand<ApplyResult> {
   ...
   * {@inheritDoc}
   *
   * <p>Executes the {@code ApplyCommand} command with all the options and parameters collected by
   * the setter methods (e.g. {@link #setPatch(InputStream)} of this class. Each instance of this
   * class should only be used for one invocation of the command. Don't call this method twice on an
   * instance.
   */
  @Override
  public ApplyResult call() throws GitAPIException {
    ...
    ApplyPatchResult applyResult = applier.applyPatch(in);
