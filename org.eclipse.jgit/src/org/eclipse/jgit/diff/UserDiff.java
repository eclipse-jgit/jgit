...
/**
 * Built-in drivers for various languages, sorted by name. These
 * drivers will be used to determine function names for a hunk.
 *
 * When writing or updating patterns, assume the contents are
 * syntactically correct. Patterns can be simple and need not
 * cover all syntactical corner cases, as long as they are
