...
public class PackConfig {
	 ...
	 * Default setting: {@value #DEFAULT_WRITE_REVERSE_INDEX}
	 *
	 * @param writeReverseIndex whether the writer should write reverse index
	 *                             files
	 */
	...
	public String toString() {
		...
		b.append(SEPARATOR).append(CONFIG_KEY_WRITE_REVERSE_INDEX)
				.append(EQUALS).append(isBuildBitmaps());
