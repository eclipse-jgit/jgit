...
public class PackConfig {
	 ...
	 *
	 * @see #setSelectObjectMaxTimeMsec(int)
	 */
	public static final int DEFAULT_SELECT_OBJECT_MAX_TIME_MSEC = -1;
	...
	private int selectObjectMaxTimeMsec = DEFAULT_SELECT_OBJECT_MAX_TIME_MSEC;
	 ...
	 * search for reuse phase
	 */
	public int getSelectObjectMaxTimeMsec() {
	 ...
	 * Default setting: {@value #DEFAULT_SELECT_OBJECT_MAX_TIME_MSEC}
	 */
	public void setSelectObjectMaxTimeMsec(int mSec) {
	...
	public void fromConfig(Config rc) {
		...
		setSelectObjectMaxTimeMsec(rc.getInt(CONFIG_PACK_SECTION,
