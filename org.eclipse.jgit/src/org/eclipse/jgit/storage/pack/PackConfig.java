...
public class PackConfig {
	...
	/**
	 * Set the maximum number of retries to fetch the pack list should be scanned in a single object lookup
	 *
         * @param maxSearchPacksCount
         *          Number of retries to fetch the pack list
	 */
