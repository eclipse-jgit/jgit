 ...
 * <p> This walk provides the {@link org.eclipse.jgit.merge.ResolveMerger} a way to process the renames in two phased
 * <ul>
...
public class RenameProcessingTreeWalk  extends NameConflictTreeWalk {
   ...
   * @param pathName the path name that should be returned as the current entry path.
   */
