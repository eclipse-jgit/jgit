...
public abstract class AndTreeFilter extends TreeFilter {
	...
	private static class Binary extends AndTreeFilter {
		...
		/**
		 * Return paths from the subfilters. This implementation doesn't support
		 * paths on both sides of the "and". Negated filters also prevent a
		 * proper calculation of paths. Using composite tree filters for
		 * multiple paths filtering is not recommended. Use
		 * {@code PathFilterGroup} instead. "
		 *
