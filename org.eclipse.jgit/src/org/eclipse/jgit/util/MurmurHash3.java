...
public final class MurmurHash3 {
	 ...
	 *
	 * <p>
	 * Modification: This method does not mask the int with 0xff, in order to
	 * give the same result as method {@code murmur3_seeded} in <a href=
	 * "https://github.com/git/git/commit/f52207a45ca9e7cfbe431f4ffff79b3fdbcf3a37">CGit</a>.
	 * </p>
	 *
	 * @param data
