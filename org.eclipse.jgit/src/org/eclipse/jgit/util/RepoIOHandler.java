...
public class RepoIOHandler implements Closeable {
	...
	/**
	 * Writes the cache changes.
	 *
	 * @return the modified tree ID if any, or null otherwise
	 * @throws IOException if any of the writes fail
	 */
	public ObjectId writeChanges() throws IOException {
	 ...
	 */
	private void cleanUpChanges() throws IOException {
		if (inCore) {
			return;
		}
	 ...
	 */
	public Repository nonNullNonBareRepo() throws NullPointerException, NoWorkTreeException {
