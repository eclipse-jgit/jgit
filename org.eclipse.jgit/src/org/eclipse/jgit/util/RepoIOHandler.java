...
public class RepoIOHandler implements Closeable {
	...
	/**
	 * Files that are listed to be during this operation.
	 */
	private final List<String> inProgressModifiedFiles = new LinkedList<>();
	...
	public Result writeChanges() throws IOException {
		...
		result.modifiedFiles.addAll(inProgressModifiedFiles);
		inProgressModifiedFiles.clear();
		result.failedToDelete = failedToDelete;
		return result;
	}
	...
	private void handleDeletedFiles() {
		...
		for (String path : toBeDeleted.descendingKeySet()) {
			...
			inProgressModifiedFiles.add(path);
		}
	}
	...
	public List<String> getModifiedFiles() {
		return inProgressModifiedFiles;
	}
	...
	private void checkout() throws NoWorkTreeException, IOException {
		...
		for (Map.Entry<String, DirCacheEntry> entry : toBeCheckedOut.entrySet()) {
			...
			if (dirCacheEntry.getFileMode() == FileMode.GITLINK) {
				...
				inProgressModifiedFiles.add(entry.getKey());
			}
		}
	}
	...
	public void revertModifiedFiles() throws IOException {
		...
		for (String path : inProgressModifiedFiles) {
