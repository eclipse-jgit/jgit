...
| `gc.autoDetach` | `true` |  &#x2705; | Make auto gc return immediately and run in background if the system supports it. |
...
| `pack.reuseoObjects` | `true` | &#x20DE; | Whether to reuse existing objects representation in repository. |
