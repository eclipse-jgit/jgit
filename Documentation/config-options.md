...
| `core.repositoryCacheCleanupDelay` | `1.hour`| &#x20DE; | Time an unused repository should expired and be evicted from the RepositoryCache. |
| `core.repositoryCacheExpireAfter`  | minimum of 1/10 of `core.repositoryCacheCleanupDelay` and `10.minutes` | &#x20DE; | Delay between the periodic cleanup of expired repositories. |
