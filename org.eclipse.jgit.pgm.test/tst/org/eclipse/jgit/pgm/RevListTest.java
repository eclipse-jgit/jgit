/*
 * Copyright (C) 2021, Tencent and others.
 *
...
public class RevListTest extends CLIRepositoryTestCase {
	...
	@Test
	public void testWithParentsFlags() throws Exception {
		List<RevCommit> commits = createCommitsForParentsFlags(git);
	...
	@Test
	public void testWithOutParentsFlags() throws Exception {
		List<RevCommit> commits = createCommitsForParentsFlags(git);
	...
	private List<RevCommit> createCommitsForParentsFlags(Git git)
			throws Exception {
