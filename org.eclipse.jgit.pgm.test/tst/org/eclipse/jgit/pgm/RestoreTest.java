...
public class RestoreTest extends CLIRepositoryTestCase {
	...
	@Test
	public void testRestoreNonExistingSingleFileFromWorkingDir() throws Exception {
		try {
			execute("git restore 12345");
			fail("Must die");
		} catch (Die e) {
	...
	@Test
	public void testRestoreNonExistingSingleFileFromIndex() throws Exception {
		try {
			execute("git restore --cached 12345");
			fail("Must die");
		} catch (Die e) {
			// expected, file not found
		}
